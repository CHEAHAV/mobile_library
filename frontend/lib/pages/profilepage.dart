...
class _ProfilePageState extends State<ProfilePage>
  ...
  final _borrowed = const [
    BorrowedBook(title: 'The Great Gatsby',   dueDate: 'DUE IN 2 DAYS',  isUrgent: true,  coverColor: Color(0xFFE8D5B0)),
    BorrowedBook(title: 'Kafka on the Shore', dueDate: 'DUE IN 12 DAYS', isUrgent: false, coverColor: Color(0xFFF5EDE0)),
    BorrowedBook(title: 'Brief History',      dueDate: 'DUE IN 18 DAYS', isUrgent: false, coverColor: Color(0xFF2D5A4E)),
  ];

  static const _onLoan       = 14;
  static const _archived     = 182;
  ...
  String get _genderLabel {
    switch (widget.user.gender.toLowerCase()) {
      ...
      default:       return '🧑  ${widget.user.gender}';
    }
  }
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
                color: _royalBlue, shape: BoxShape.circle),
  ...
  Widget _statsRow() => Padding(
        ...
        child: Row(
          children: [
            _statCard(_onLoan.toString(),       'ON LOAN'),
            const SizedBox(width: 10),
            _statCard(_archived.toString(),     'ARCHIVED'),
            const SizedBox(width: 10),
            _statCard(_reservations.toString(), 'RESERVATIONS'),
          ],
        ),
      );
